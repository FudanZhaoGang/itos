...
parser.add_argument("--model_checkpoint", type=str, default="thu-coai/CDial-GPT_LCCC-large",
...
#
#
# def sample_sequence(history, tokenizer, model, temperature, top_p, top_k, no_sample, min_length, max_length, device):
#     special_tokens_ids = tokenizer.convert_tokens_to_ids(SPECIAL_TOKENS)
#     current_output = []
